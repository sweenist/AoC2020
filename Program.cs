...
namespace AdventOfCode1
{
    class Program
    {
        ...
        private static IEnumerable inputs
        {
            get
            {
                yield return 1446;
        ...
        {
            var inputList = inputs.Cast<int>().ToList();

            Problem1(inputList);
            Problem2(inputList);
        }

        private static int Problem1(List<int> inputList)
        {
        ...
        private static int Problem2(List<int> inputList)
        {
            for (var i = 0; i < inputList.Count; i++)
            {
                for (var j = i + 1; j < inputList.Count; j++)
